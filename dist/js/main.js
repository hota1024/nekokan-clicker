...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_enchant__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_enchant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_enchant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TargetNekokan__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Nekokan__ = __webpack_require__(5);
...
function main(core) {
    ...
    // Neko
    var cat = new Sprite(600, 600);
    cat.image = core.assets['assets/neko1.png'];
    cat.x = 0;
    cat.y = 0;
    cat.level = 0;
    cat.getNextLevelNekokan = function () {
        return (cat.level + 1) * 25;
    };
    ...
    var giveButton = new Sprite(960, 720);
    ...
    targetNekokan.addEventListener('touchstart', function () {
        nekokanCount++;
        var nekokan = Object(__WEBPACK_IMPORTED_MODULE_3__Nekokan__["a" /* default */])(core);
        nekokanList.push(nekokan);
        GameScene.addChild(nekokan);
    });

    giveButton.addEventListener('touchstart', function () {
        if (nekokanCount < cat.getNextLevelNekokan()) return;
        nekokanCount -= cat.getNextLevelNekokan();
        cat.level++;
    });

    nekokanCountLabel.addEventListener('enterframe', function () {
        nekokanCountLabel.text = nekokanCount.toString();
    });

    levelUpLabel.addEventListener('enterframe', function () {
        levelUpLabel.text = '\u306D\u3053\u304B\u3093\u3092\u300C' + cat.getNextLevelNekokan() + '\u300D\u500B\u3042\u3052\u307E\u3059\u304B\uFF1F';
    });

    cat.addEventListener('enterframe', function () {
...
window.onload = function () {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__assets__["a" /* default */])(core);
...
(function (window, undefined) {
     ...
     * @name enchant
     */
    var enchant = function enchant(modules) {
        if (modules != null) {
        ...
        (function include(module, prefix) {
            ...
            for (var prop in module) {
                if (module.hasOwnProperty(prop)) {
                    ...
                    } else if (_typeof(module[prop]) === 'object' && module[prop] !== null && Object.getPrototypeOf(module[prop]) === Object.prototype) {
                        if (modules == null) {
    ...
    enchant.Class.create = function (superclass, definition) {
        ...
        for (var prop in definition) {
            if (definition.hasOwnProperty(prop)) {
                if (_typeof(definition[prop]) === 'object' && definition[prop] !== null && Object.getPrototypeOf(definition[prop]) === Object.prototype) {
    ...
    enchant.Event = enchant.Class.create({
        ...
        _initPosition: function _initPosition(pageX, pageY) {
    ...
    enchant.EventTarget = enchant.Class.create({
         ...
         * @param {String} type Type of the events.
         */
        clearEventListener: function clearEventListener(type) {
            if (type != null) {
    ...
    (function () {
        ...
        enchant.Core = enchant.Class.create(enchant.EventTarget, {
            ...
            initialize: function initialize(width, height) {
                ...
                (function detectAssets(module) {
                    ...
                    for (var prop in module) {
                        if (module.hasOwnProperty(prop)) {
                            if (_typeof(module[prop]) === 'object' && module[prop] !== null && Object.getPrototypeOf(module[prop]) === Object.prototype) {
            ...
            _oncoreresize: function _oncoreresize(e) {
            ...
            preload: function preload(assets) {
                ...
                if (!(assets instanceof Array)) {
                    if ((typeof assets === 'undefined' ? 'undefined' : _typeof(assets)) === 'object') {
                        a = [];
             ...
             */
            load: function load(src, alias, callback, onerror) {
                var assetName;
            ...
            start: function start(deferred) {
                var onloadTimeSetter = function onloadTimeSetter() {
                    this.frame = 0;
                ...
                if (!this._activated) {
                    ...
                    if (enchant.ENV.BROWSER === 'mobilesafari' && enchant.ENV.USE_WEBAUDIO && enchant.ENV.USE_TOUCH_TO_START_SCENE) {
                        var d = new enchant.Deferred();
             ...
             * @private
             */
            _requestNextFrame: function _requestNextFrame(delay) {
                if (!this.ready) {
                    return;
                }
             ...
             * @private
             */
            _callTick: function _callTick(time) {
                enchant.Core.instance._tick(time);
            },
            _tick: function _tick(time) {
             ...
             * @return {enchant.Scene} The new Scene.
             */
            replaceScene: function replaceScene(scene) {
                this.popScene();
            ...
            _buttonListener: function _buttonListener(e) {
                this.currentScene.dispatchEvent(e);
            },
            /**
             ...
             * @return {enchant.Core} this
             */
            keybind: function keybind(key, button) {
            ...
            changeButtonState: function changeButtonState(button, bool) {
        ...
        enchant.Core._loadFuncs['jpg'] = enchant.Core._loadFuncs['jpeg'] = enchant.Core._loadFuncs['gif'] = enchant.Core._loadFuncs['png'] = enchant.Core._loadFuncs['bmp'] = function (src, ext, callback, onerror) {
            return enchant.Surface.load(src, callback, onerror);
        };
        enchant.Core._loadFuncs['mp3'] = enchant.Core._loadFuncs['aac'] = enchant.Core._loadFuncs['m4a'] = enchant.Core._loadFuncs['wav'] = enchant.Core._loadFuncs['ogg'] = function (src, ext, callback, onerror) {
    ...
    enchant.InputManager = enchant.Class.create(enchant.EventTarget, {
         ...
         * @extends enchant.EventTarget
         */
        initialize: function initialize(valueStore, source) {
            enchant.EventTarget.call(this);
         ...
         */
        bind: function bind(inputSource, name) {
         ...
         * @param {enchant.InputSource} inputSource input source.
         */
        unbind: function unbind(inputSource) {
         ...
         */
        addBroadcastTarget: function addBroadcastTarget(eventTarget) {
         ...
         * @param {enchant.EventTarget} eventTarget broadcast target.
         */
        removeBroadcastTarget: function removeBroadcastTarget(eventTarget) {
            var i = this.broadcastTarget.indexOf(eventTarget);
            if (i !== -1) {
         ...
         */
        broadcastEvent: function broadcastEvent(e) {
    ...
    enchant.InputSource = enchant.Class.create(enchant.EventTarget, {
         ...
         * @extends enchant.EventTarget
         */
        initialize: function initialize(identifier) {
            enchant.EventTarget.call(this);
            /**
         ...
         * @param {*} data state.
         */
        notifyStateChange: function notifyStateChange(data) {
    ...
    enchant.BinaryInputManager = enchant.Class.create(enchant.InputManager, {
         ...
         */
        initialize: function initialize(flagStore, activeEventNameSuffix, inactiveEventNameSuffix, source) {
         ...
         */
        bind: function bind(binaryInputSource, name) {
         ...
         */
        unbind: function unbind(binaryInputSource) {
         ...
         */
        changeState: function changeState(name, bool) {
            if (bool) {
                this._down(name);
            } else {
                this._up(name);
    ...
    enchant.KeyboardInputManager = enchant.Class.create(enchant.BinaryInputManager, {
         ...
         */
        initialize: function initialize(domElement, flagStore) {
         ...
         * @param {String} name input name.
         */
        keybind: function keybind(keyCode, name) {
         ...
         * @param {Number} keyCode key code.
         */
        keyunbind: function keyunbind(keyCode) {
            this.unbind(enchant.KeyboardInputSource.getByKeyCode('' + keyCode));
        },
        _attachDOMEvent: function _attachDOMEvent(domElement, eventType, state) {
    ...
    enchant.KeyboardInputSource = enchant.Class.create(enchant.BinaryInputSource, {
         ...
         */
        initialize: function initialize(keyCode) {
    ...
    var _intersectBetweenClassAndInstance = function _intersectBetweenClassAndInstance(Class, instance) {
        var ret = [];
        var c;
    ...
    var _intersectBetweenClassAndClass = function _intersectBetweenClassAndClass(Class1, Class2) {
        var ret = [];
        var c1, c2;
    ...
    var _intersectStrictBetweenClassAndInstance = function _intersectStrictBetweenClassAndInstance(Class, instance) {
        var ret = [];
        var c;
        for (var i = 0, l = Class.collection.length; i < l; i++) {
            c = Class.collection[i];
    ...
    var _intersectStrictBetweenClassAndClass = function _intersectStrictBetweenClassAndClass(Class1, Class2) {
        var ret = [];
        var c1, c2;
        for (var i = 0, l = Class1.collection.length; i < l; i++) {
            c1 = Class1.collection[i];
    ...
    var _staticIntersect = function _staticIntersect(other) {
    ...
    var _staticIntersectStrict = function _staticIntersectStrict(other) {
        if (other instanceof enchant.Entity) {
    ...
    enchant.Entity = enchant.Class.create(enchant.Node, {
        ...
        _intersectOne: function _intersectOne(other) {
            if (this._dirty) {
                this._updateCoordinate();
            }if (other._dirty) {
                other._updateCoordinate();
            }
            return this._offsetX < other._offsetX + other.width && other._offsetX < this._offsetX + this.width && this._offsetY < other._offsetY + other.height && other._offsetY < this._offsetY + this.height;
        },
        intersectStrict: function intersectStrict(other) {
            if (other instanceof enchant.Entity) {
        ...
        _intersectStrictOne: function _intersectStrictOne(other) {
            if (this._dirty) {
                this._updateCoordinate();
            }if (other._dirty) {
                other._updateCoordinate();
            ...
            var rect1 = this.getOrientedBoundingRect(),
                ...
                c1,
                c2;
            if (t1[0] * (cy2 - lty1) - t1[1] * (cx2 - ltx1) > 0 && r1[0] * (cy2 - rty1) - r1[1] * (cx2 - rtx1) > 0 && b1[0] * (cy2 - rby1) - b1[1] * (cx2 - rbx1) > 0 && l1[0] * (cy2 - lby1) - l1[1] * (cx2 - lbx1) > 0) {
                return true;
            } else if (t2[0] * (cy1 - lty2) - t2[1] * (cx1 - ltx2) > 0 && r2[0] * (cy1 - rty2) - r2[1] * (cx1 - rtx2) > 0 && b2[0] * (cy1 - rby2) - b2[1] * (cx1 - rbx2) > 0 && l2[0] * (cy1 - lby2) - l2[1] * (cx1 - lbx2) > 0) {
                return true;
            } else {
        ...
        within: function within(other, distance) {
            ...
            var _;
            return (_ = this._offsetX - other._offsetX + (this.width - other.width) / 2) * _ + (_ = this._offsetY - other._offsetY + (this.height - other.height) / 2) * _ < distance * distance;
        },
        /**
    ...
    var _collectizeConstructor = function _collectizeConstructor(Constructor) {
    ...
    enchant.Sprite = enchant.Class.create(enchant.Entity, {
        ...
        _frameSequence: {
            ...
            set: function set(frameSequence) {
         ...
         * @private
         */
        _deepCompareToPreviousFrame: function _deepCompareToPreviousFrame(frameArray) {
        ...
        /**#nocode-*/
        cvsRender: function cvsRender(ctx) {
            var image = this._image,
                w = this._width,
                h = this._height,
                iw,
    ...
    enchant.Label = enchant.Class.create(enchant.Entity, {
        ...
        domRender: function domRender(element) {
            if (element.innerHTML !== this._text) {
                element.innerHTML = this._text;
            }
        },
        detectRender: function detectRender(ctx) {
        ...
        getMetrics: function getMetrics(text) {
            var ret = {};
    ...
    enchant.Map = enchant.Class.create(enchant.Entity, {
         ...
         * @extends enchant.Entity
         */
        initialize: function initialize(tileWidth, tileHeight) {
            var core = enchant.Core.instance;
         ...
         * @private
         */
        redraw: function redraw(x, y, width, height) {
            if (this._image == null) {
                return;
            }
    ...
    enchant.Group = enchant.Class.create(enchant.Node, {
        ...
        initialize: function initialize() {
            ...
            [enchant.Event.ADDED_TO_SCENE, enchant.Event.REMOVED_FROM_SCENE].forEach(function (event) {
         ...
         */
        insertBefore: function insertBefore(node, reference) {
            if (node.parentNode) {
                node.parentNode.removeChild(node);
            }
    ...
    enchant.Matrix = enchant.Class.create({
        ...
        makeTransformMatrix: function makeTransformMatrix(node, dest) {
            var x = node._x;
            var y = node._y;
        ...
        multiply: function multiply(m1, m2, dest) {
            var a11 = m1[0],
                a21 = m1[2],
                adx = m1[4],
                a12 = m1[1],
        ...
        multiplyVec: function multiplyVec(mat, vec, dest) {
            var x = vec[0],
                y = vec[1];
            var m11 = mat[0],
                m21 = mat[2],
    ...
    enchant.DetectColorManager = enchant.Class.create({
        initialize: function initialize(reso, max) {
            this.reference = [];
        ...
        attachDetectColor: function attachDetectColor(sprite) {
        ...
        detachDetectColor: function detachDetectColor(sprite) {
            var i = this.reference.indexOf(sprite);
            if (i !== -1) {
                this.reference[i] = null;
            }
        },
        _getColor: function _getColor(n) {
            var C = this.colorResolution;
            var d = C / this.max;
            return [parseInt(n / C / C % C, 10) / d, parseInt(n / C % C, 10) / d, parseInt(n % C, 10) / d, 1.0];
        },
        _decodeDetectColor: function _decodeDetectColor(color, i) {
            i = i || 0;
            var C = this.colorResolution;
            return ~~(color[i] * C * C * C / 256) + ~~(color[i + 1] * C * C / 256) + ~~(color[i + 2] * C / 256);
        },
        getSpriteByColor: function getSpriteByColor(color) {
            return this.reference[this._decodeDetectColor(color)];
        },
        getSpriteByColors: function getSpriteByColors(rgba) {
            var i,
                l,
                id,
                result,
    ...
    enchant.DomManager = enchant.Class.create({
        initialize: function initialize(node, elementDefinition) {
            var core = enchant.Core.instance;
            this.layer = null;
        ...
        getNextManager: function getNextManager(manager) {
        ...
        addManager: function addManager(childManager, nextManager) {
            var nextElement;
            if (nextManager) {
        ...
        removeManager: function removeManager(childManager) {
        ...
        render: function render(inheritMat) {
            var node = this.targetNode;
            var matrix = enchant.Matrix.instance;
            var stack = matrix.stack;
            var dest = [];
            ...
            if (node._dirty) {
                this.style[enchant.ENV.VENDOR_PREFIX + 'Transform'] = 'matrix(' + dest[0].toFixed(10) + ',' + dest[1].toFixed(10) + ',' + dest[2].toFixed(10) + ',' + dest[3].toFixed(10) + ',' + dest[4].toFixed(10) + ',' + dest[5].toFixed(10) + ')';
            }
            this.domRender();
        },
    ...
    enchant.DomlessManager = enchant.Class.create({
        ...
        _register: function _register(element, nextElement) {
    ...
    enchant.DomLayer = enchant.Class.create(enchant.Group, {
        initialize: function initialize() {
            ...
            var __onchildadded = function __onchildadded(e) {
                var child = e.node;
                var next = e.next;
                var self = e.target;
            ...
            var __onchildremoved = function __onchildremoved(e) {
                var child = e.node;
                var self = e.target;
        ...
        _rendering: function _rendering(node, e, inheritMat) {
            var child;
            if (!inheritMat) {
    ...
    enchant.CanvasLayer = enchant.Class.create(enchant.Group, {
        ...
        _determineEventTarget: function _determineEventTarget(e) {
            return this._getEntityByPosition(e.x, e.y);
        },
        _getEntityByPosition: function _getEntityByPosition(x, y) {
            var core = enchant.Core.instance;
            var ctx = this._dctx;
    ...
    enchant.CanvasRenderer = enchant.Class.create({
        render: function render(ctx, node, e) {
        ...
        detectRender: function detectRender(ctx, node) {
            var width, height, child;
            if (typeof node._visible === 'undefined' || node._visible) {
                width = node.width;
                height = node.height;
        ...
        transform: function transform(ctx, node) {
            var matrix = enchant.Matrix.instance;
            var stack = matrix.stack;
    ...
    enchant.Scene = enchant.Class.create(enchant.Group, {
        ...
        addLayer: function addLayer(type, i) {
            var core = enchant.Core.instance;
        ...
        _onchildadded: function _onchildadded(e) {
            var child = e.node;
            var next = e.next;
            var target, i;
            if (child._element) {
        ...
        _onchildremoved: function _onchildremoved(e) {
            var child = e.node;
    ...
    enchant.DOMSound.load = function (src, type, callback, onerror) {
        ...
        var audio = new Audio();
        if (!enchant.ENV.SOUND_ENABLED_ON_MOBILE_SAFARI && enchant.ENV.VENDOR_PREFIX === 'webkit' && enchant.ENV.TOUCH_ENABLED) {
    ...
    enchant.Easing = {
        ...
        // *** quad
        QUAD_EASEIN: function QUAD_EASEIN(t, b, c, d) {
            return c * (t /= d) * t + b;
        },

        QUAD_EASEOUT: function QUAD_EASEOUT(t, b, c, d) {
            return -c * (t /= d) * (t - 2) + b;
        },

        QUAD_EASEINOUT: function QUAD_EASEINOUT(t, b, c, d) {
            if ((t /= d / 2) < 1) {
                return c / 2 * t * t + b;
            }
        ...
        // *** cubic
        CUBIC_EASEIN: function CUBIC_EASEIN(t, b, c, d) {
            return c * (t /= d) * t * t + b;
        },

        CUBIC_EASEOUT: function CUBIC_EASEOUT(t, b, c, d) {
            return c * ((t = t / d - 1) * t * t + 1) + b;
        },

        CUBIC_EASEINOUT: function CUBIC_EASEINOUT(t, b, c, d) {
            if ((t /= d / 2) < 1) {
                return c / 2 * t * t * t + b;
            }
        ...
        // *** quart
        QUART_EASEIN: function QUART_EASEIN(t, b, c, d) {
            return c * (t /= d) * t * t * t + b;
        },

        QUART_EASEOUT: function QUART_EASEOUT(t, b, c, d) {
            return -c * ((t = t / d - 1) * t * t * t - 1) + b;
        },

        QUART_EASEINOUT: function QUART_EASEINOUT(t, b, c, d) {
            if ((t /= d / 2) < 1) {
        ...
        // *** quint
        QUINT_EASEIN: function QUINT_EASEIN(t, b, c, d) {
            return c * (t /= d) * t * t * t * t + b;
        },

        QUINT_EASEOUT: function QUINT_EASEOUT(t, b, c, d) {
            return c * ((t = t / d - 1) * t * t * t * t + 1) + b;
        },

        QUINT_EASEINOUT: function QUINT_EASEINOUT(t, b, c, d) {
            if ((t /= d / 2) < 1) {
        ...
        // *** sin
        SIN_EASEIN: function SIN_EASEIN(t, b, c, d) {
            return -c * Math.cos(t / d * (Math.PI / 2)) + c + b;
        },

        SIN_EASEOUT: function SIN_EASEOUT(t, b, c, d) {
            return c * Math.sin(t / d * (Math.PI / 2)) + b;
        },

        SIN_EASEINOUT: function SIN_EASEINOUT(t, b, c, d) {
            return -c / 2 * (Math.cos(Math.PI * t / d) - 1) + b;
        },

        // *** circ
        CIRC_EASEIN: function CIRC_EASEIN(t, b, c, d) {
            return -c * (Math.sqrt(1 - (t /= d) * t) - 1) + b;
        },

        CIRC_EASEOUT: function CIRC_EASEOUT(t, b, c, d) {
            return c * Math.sqrt(1 - (t = t / d - 1) * t) + b;
        },

        CIRC_EASEINOUT: function CIRC_EASEINOUT(t, b, c, d) {
            if ((t /= d / 2) < 1) {
        ...
        // *** elastic
        ELASTIC_EASEIN: function ELASTIC_EASEIN(t, b, c, d, a, p) {
            if (t === 0) {
                return b;
            }
            if ((t /= d) === 1) {
        ...
        ELASTIC_EASEOUT: function ELASTIC_EASEOUT(t, b, c, d, a, p) {
            if (t === 0) {
                return b;
            }
            if ((t /= d) === 1) {
        ...
        ELASTIC_EASEINOUT: function ELASTIC_EASEINOUT(t, b, c, d, a, p) {
            if (t === 0) {
                return b;
            }
            if ((t /= d / 2) === 2) {
        ...
        BOUNCE_EASEIN: function BOUNCE_EASEIN(t, b, c, d) {
            return c - enchant.Easing.BOUNCE_EASEOUT(d - t, 0, c, d) + b;
        },

        BOUNCE_EASEINOUT: function BOUNCE_EASEINOUT(t, b, c, d) {
            if (t < d / 2) {
        ...
        // *** back
        BACK_EASEIN: function BACK_EASEIN(t, b, c, d, s) {
            if (s === undefined) {
                s = 1.70158;
            }
        ...
        BACK_EASEOUT: function BACK_EASEOUT(t, b, c, d, s) {
            if (s === undefined) {
                s = 1.70158;
            }
        ...
        BACK_EASEINOUT: function BACK_EASEINOUT(t, b, c, d, s) {
            if (s === undefined) {
                s = 1.70158;
            }
            if ((t /= d / 2) < 1) {
        ...
        EXPO_EASEOUT: function EXPO_EASEOUT(t, b, c, d) {
            return t === d ? b + c : c * (-Math.pow(2, -10 * t / d) + 1) + b;
        },

        EXPO_EASEINOUT: function EXPO_EASEINOUT(t, b, c, d) {
            if (t === 0) {
                return b;
            }
            if (t === d) {
    ...
    enchant.Timeline = enchant.Class.create(enchant.EventTarget, {
         ...
         * @private
         */
        _onenterframe: function _onenterframe(evt) {
            if (this.paused) {
                return;
            }
        ...
        /**
         */
        next: function next(remainingTime) {
            var e,
        ...
        then: function then(func) {
            return this.action({
                onactiontick: function onactiontick(evt) {
                    func.call(this);
                },
         ...
         * @return {enchant.Timeline}
         */
        cue: function cue(_cue) {
            var ptr = 0;
            for (var frame in _cue) {
                if (_cue.hasOwnProperty(frame)) {
                    this.delay(frame - ptr);
                    this.then(_cue[frame]);
                    ptr = frame;
                }
            }
            return this;
         ...
         * @return {enchant.Timeline}
         */
        repeat: function repeat(func, time) {
            return this.action({
                onactiontick: function onactiontick(evt) {
                    func.call(this);
                },
         ...
         * @return {enchant.Timeline}
         */
        waitUntil: function waitUntil(func) {
            return this.action({
                onactiontick: function onactiontick(evt) {
                    if (func.call(this)) {
                        evt.timeline.next();
         ...
         * @return {enchant.Timeline}
         */
        fadeTo: function fadeTo(opacity, time, easing) {
            return this.tween({
                opacity: opacity,
                time: time,
                easing: easing
         ...
         * @return {enchant.Timeline}
         */
        fadeIn: function fadeIn(time, easing) {
         ...
         * @return {enchant.Timeline}
         */
        fadeOut: function fadeOut(time, easing) {
         ...
         * @return {enchant.Timeline}
         */
        moveTo: function moveTo(x, y, time, easing) {
            return this.tween({
                x: x,
                y: y,
                time: time,
         ...
         * @return {enchant.Timeline}
         */
        moveX: function moveX(x, time, easing) {
            return this.tween({
                x: x,
                time: time,
                easing: easing
         ...
         * @return {enchant.Timeline}
         */
        moveY: function moveY(y, time, easing) {
            return this.tween({
                y: y,
                time: time,
                easing: easing
         ...
         * @return {enchant.Timeline}
         */
        moveBy: function moveBy(_x, _y, time, easing) {
            return this.tween({
                x: function x() {
                    return this.x + _x;
                },
         ...
         * @return {enchant.Timeline}
         */
        scaleTo: function scaleTo(scale, time, easing) {
            var scaleX, scaleY;
         ...
         * @return {enchant.Timeline}
         */
        scaleBy: function scaleBy(scale, time, easing) {
            var _scaleX, _scaleY;
            ...
            return this.tween({
                scaleX: function scaleX() {
                    return this.scaleX * _scaleX;
                },
                scaleY: function scaleY() {
                    return this.scaleY * _scaleY;
                },
                time: time,
                easing: easing
            });
         ...
         * @return {enchant.Timeline}
         */
        rotateTo: function rotateTo(deg, time, easing) {
            return this.tween({
                rotation: deg,
                time: time,
                easing: easing
         ...
         * @return {enchant.Timeline}
         */
        rotateBy: function rotateBy(deg, time, easing) {
            return this.tween({
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (core) {
    core.preload('assets/neko1.png');
    core.preload('assets/neko-kan.png');
    core.preload('assets/batu.png');
    core.preload('assets/give.png');
});
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (core) {
    var targetNekokan = new Sprite(600, 600);
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (core) {
    var nekokan = new Sprite(600, 600);
